...
class T(unittest.TestCase):
 ...
 def visual_handoff(s,result='PASS'):
  return embed({'schema_version':G.VISUAL_HANDOFF_SCHEMA,'runner_pr':15,'runner_head':'8'*40,'private_pr':349,'private_branch':'repair/gold-s01-visual-runtime-v2','private_sha':'4'*40,'result':result,'production_adapter_git_blob_sha':'5'*40,'no_render_manifest_path':'03_modules/M1/L01/gold_v2/no_render_manifest.json','no_render_manifest_git_blob_sha':'6'*40,'no_render_manifest_sha256':'7'*64,'visual_input_fingerprint':'f'*64,'private_render_request_sha256':'e'*64,'shot_ir_count':26,'scene_ir_count':26,'no_fake_green':True})
