...
class T(unittest.TestCase):
 ...
 def test_materialization_exact_hashes(s):
  ...
  with mock.patch.dict(os.environ,{'GITHUB_ACTIONS':'false'},clear=False):s.assertEqual(G.materialize_and_verify_inputs(q,p,r,r,r)['visual_input_fingerprint'],f)
  (r/c).write_text('bad');s.err('CHECKOUT_DIRTY',G.materialize_and_verify_inputs,q,p,r,r,r)
